<template>
  <div class="editShiftRules">
    ...
    <high-search @change="barSearch" :showUseLogic="false" privilege="schedule_editschhistory#view" :config="highConfig" :hideSearch="true"></high-search>
    <div>
      <wq-table
        v-loading="loading"
        :border-header="true"
